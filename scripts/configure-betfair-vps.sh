...
CERT_DIR="${CERT_DIR:-$APP_DIR/runtime/betfair/certs}"
...
main() {
  ...
  set_env_key "RORY_TRADER_TENNIS_MIN_HOURS_TO_EVENT" "${RORY_TRADER_TENNIS_MIN_HOURS_TO_EVENT:-0.5}"
  set_env_key "RORY_TRADER_TENNIS_MAX_HOURS_TO_EVENT" "${RORY_TRADER_TENNIS_MAX_HOURS_TO_EVENT:-72}"
  set_env_key "RORY_TRADER_TENNIS_MAX_SPREAD" "${RORY_TRADER_TENNIS_MAX_SPREAD:-0.2}"
  set_env_key "RORY_TRADER_TENNIS_MIN_MARKET_TOTAL_MATCHED" "${RORY_TRADER_TENNIS_MIN_MARKET_TOTAL_MATCHED:-50}"
  set_env_key "RORY_TRADER_BETFAIR_TENNIS_MARKET_TYPES" "${RORY_TRADER_BETFAIR_TENNIS_MARKET_TYPES:-MATCH_ODDS,SET_WINNER}"
  set_env_key "RORY_TRADER_BETFAIR_TENNIS_MIN_START_MINUTES" "${RORY_TRADER_BETFAIR_TENNIS_MIN_START_MINUTES:-30}"
  set_env_key "RORY_TRADER_BETFAIR_TENNIS_MAX_START_HOURS" "${RORY_TRADER_BETFAIR_TENNIS_MAX_START_HOURS:-72}"
  set_env_key "BETFAIR_MARKETS_CATEGORY" "${BETFAIR_MARKETS_CATEGORY:-tennis}"
  set_env_key "BETFAIR_MARKETS_MAX_RESULTS" "${BETFAIR_MARKETS_MAX_RESULTS:-100}"
