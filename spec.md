...
- Betfair market-data and account validation support
- Smarkets market-data and approval-aware integration support
...
4. add Betfair and Smarkets market-data access with normalized internal models
5. add a paper-trading-only execution path with explicit safety rails

## Non-Goals

The first milestone must not include:
- live auto-trading
- unattended daemons or background bots
...
- exchange-native order payload construction for future use

The first milestone must not submit live orders.
